...
def get_dataset(
    ...
    if dataset_name == "SemanticKITTI":
        ...
        validation_dataset = SemanticKITTIDataset(
            dataset_path=dataset_path,
            mapping_path=mapping_path,
            version=version,
            phase="validation",
        ...
        training_dataset = SynLiDARDataset(
            dataset_path=dataset_path,
            version=version,
            phase="train",
            voxel_size=voxel_size,
        ...
        if target_name == "SemanticKITTI":
            ...
            target_dataset_path = os.path.join(
                main_path, "SemanticKITTI/data/sequences/"
            )
            ...
            target_dataset = SemanticPOSSDataset(
                dataset_path=target_dataset_path,
                mapping_path=target_mapping_path,
                version=version,
                phase="validation",
        ...
        training_dataset = SemanticPOSSDataset(
            dataset_path=dataset_path,
            mapping_path=mapping_path,
            version=version,
            phase="train",
        ...
        validation_dataset = SemanticPOSSDataset(
            dataset_path=dataset_path,
            mapping_path=mapping_path,
            version=version,
            phase="validation",
        ...
        training_dataset = NuScenesDataset(
            dataset_path=dataset_path,
            mapping_path=mapping_path,
            version=version,
            phase="train",
        ...
        validation_dataset = NuScenesDataset(
            dataset_path=dataset_path,
            mapping_path=mapping_path,
            version=version,
            phase="validation",
